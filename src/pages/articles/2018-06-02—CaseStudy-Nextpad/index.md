...
## Fazit
An dieser Case Study ist der Unterschied von UX- und UI-Design exemplarisch erkennbar. Der Fokus lag klar auf dem UX-Design, sprich wie der User durch die Anwendung geführt werden soll. Selbstverständlich hat das Interface-Design auch seine Berechtigung, doch wird dieses weiter hinten angesiedelt. Erst muss klar sein, was die Applikation können bzw. bieten soll und in einem zweiten Schritt geht es stärker um gestalterische Themen wie Typografie, Farbe etc. Schön zu sehen, was innerhalb eines Tages für Resultate vorliegen. Alle Gruppen haben eine Basis erarbeitet, auf dieser man gut weiterarbeiten kann. Am Punkt X wäre sicher ein Usertest ein gewinnbringender Schritt – von Vorteil in möglichst frühem Statium mittels eines Prototypes bzw. Klickdummys. So kann festgestellt werden, wie der Enduser mit der Applikation zurecht kommt und wo er stoplert. Schlussendlich liegt der Erfolg einer Applikation sowohl im Konzept over all als auch im Kleinen, was Microinteracions etc. anbelangt. Das Spielfeld des Interaction Designs ist gross ...
