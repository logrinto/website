...
<div class="wide-grid bg">
  ...
  <div class="col-1to4">
    <figure class="border">
      <img src="img/app/IMG_8551.PNG" alt="test">
      <figcaption>suchen</figcaption>
    </figure>
  </div>
  <div class="col-5to8">
    <figure class="border">
      <img src="img/app/IMG_8552.PNG" alt="test">
      <figcaption>wählen</figcaption>
    </figure>
  </div>
  <div class="col-9to12">
    <figure class="border">
      <img src="img/app/IMG_8549.PNG" alt="test">
...
<div class="wide-grid bg">
  ...
  <div class="col-1to6">
    <figure class="border">
      <img src="img/unterricht/jpg/IMG_8546.jpg" alt="test">
      <figcaption>Wichtige Eckpunkte eingezeichnet</figcaption>
    </figure>
  </div>
  <div class="col-7to12">
    <figure class="border">
      <img src="img/unterricht/jpg/IMG_8548.jpg" alt="test">
...
<div class="wide-grid bg">
  <div class="col-1to6">
    <figure class="border">
      <img src="img/unterricht/jpg/IMG_8566.jpg" alt="test">
      <figcaption>suchen</figcaption>
    </figure>
  </div>
  <div class="col-7to12">
    <figure class="border">
      <img src="img/unterricht/jpg/IMG_8568.jpg" alt="test">
      <figcaption>wählen</figcaption>
    </figure>
  </div>
</div>
...
<div class="wide-grid bg">
  ...
  <div class="col-1to3">
    <figure class="border">
      <img src="img/groupA/GroupA_01.png" alt="test">
      <figcaption>Startscreen</figcaption>
    </figure>
  </div>
  <div class="col-4to6">
    <figure class="border">
    <img src="img/groupA/GroupA_02.png" alt="test">
      <figcaption>Vorschlag für das nächste Bike</figcaption>
    </figure>
  </div>
  <div class="col-7to9">
    <figure class="border">
    <img src="img/groupA/GroupA_03.png" alt="test">
      <figcaption>Optional noch weiter Bikes</figcaption>
    </figure>
  </div>
  <div class="col-10to12">
    <figure class="border">
    <img src="img/groupA/GroupA_04.png" alt="test">
      <figcaption>Reservieren</figcaption>
    </figure>
  </div>
  ...
  <div class="col-1to3">
    <figure class="border">
      <img src="img/groupA/GroupA_05.png" alt="test">
      <figcaption>Wayfinding</figcaption>
    </figure>
  </div>
  <div class="col-4to6">
    <figure class="border">
    <img src="img/groupA/GroupA_06.png" alt="test">
      <figcaption>Optional Infos zur Reservation</figcaption>
    </figure>
  </div>
  <div class="col-7to9">
    <figure class="border">
    <img src="img/groupA/GroupA_08.png" alt="test">
  ...
  <div class="col-1to3">
    <figure class="border">
      <img src="img/groupA/GroupA_10.png" alt="test">
      <figcaption>Bike buchen</figcaption>
    </figure>
  </div>
  <div class="col-4to6">
    <figure class="border">
    <img src="img/groupA/GroupA_11.png" alt="test">
...
<div class="wide-grid bg">
  ...
  <div class="col-1to3">
    <figure class="border">
      <img src="./img/groupB/GroupB_01.png" alt="test">
      <figcaption>Startscreen</figcaption>
    </figure>
  </div>
  <div class="col-4to6">
    <figure class="border">
    <img src="./img/groupB/GroupB_02.png" alt="test">
      <figcaption>Bikewahl</figcaption>
    </figure>
  </div>
  <div class="col-7to9">
    <figure class="border">
    <img src="./img/groupB/GroupB_03.png" alt="test">
      <figcaption>Bike-Vorschlag</figcaption>
    </figure>
  </div>
  <div class="col-10to12">
    <figure class="border">
    <img src="./img/groupB/GroupB_04.png" alt="test">
  ...
  <div class="col-1to3">
    <figure class="border">
      <img src="./img/groupB/GroupB_05.png" alt="test">
      <figcaption>Wayfinding</figcaption>
    </figure>
  </div>
  <div class="col-4to6">
    <figure class="border">
    <img src="./img/groupB/GroupB_06.png" alt="test">
      <figcaption>Buchen</figcaption>
    </figure>
  </div>
  <div class="col-7to9">
    <figure class="border">
    <img src="./img/groupB/GroupB_07.png" alt="test">
      <figcaption>Fahrzeit</figcaption>
    </figure>
  </div>
  <div class="col-10to12">
    <figure class="border">
    <img src="./img/groupB/GroupB_08.png" alt="test">
...
<div class="wide-grid bg">
  ...
  <div class="col-1to3">
    <figure class="border">
      <img src="img/groupC/GroupC_01.png" alt="test">
      <figcaption>Startscreen</figcaption>
    </figure>
  </div>
  <div class="col-4to6">
    <figure class="border">
    <img src="img/groupC/GroupC_02.png" alt="test">
      <figcaption>Karte E-Bike Empfehlung</figcaption>
    </figure>
  </div>
  <div class="col-7to9">
    <figure class="border">
    <img src="img/groupC/GroupC_03.png" alt="test">
      <figcaption>Settings-Menü</figcaption>
    </figure>
  </div>
  <div class="col-10to12">
    <figure class="border">
    <img src="img/groupC/GroupC_04.png" alt="test">
  ...
  <div class="col-1to3">
    <figure class="border">
      <img src="img/groupC/GroupC_05.png" alt="test">
      <figcaption>Selektion</figcaption>
    </figure>
  </div>
  <div class="col-4to6">
    <figure class="border">
    <img src="img/groupC/GroupC_06.png" alt="test">
      <figcaption>Reservation</figcaption>
    </figure>
  </div>
  <div class="col-7to9">
    <figure class="border">
    <img src="img/groupC/GroupC_07.png" alt="test">
      <figcaption>Wayfinding</figcaption>
    </figure>
  </div>
  <div class="col-10to12">
    <figure class="border">
    <img src="img/groupC/GroupC_08.png" alt="test">
      <figcaption>Buchen</figcaption>
    </figure>
  </div>
